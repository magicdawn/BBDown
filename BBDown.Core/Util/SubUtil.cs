...
namespace BBDown.Core.Util
{
    public partial class SubUtil
    {
        ...
        private static async Task<List<Subtitle>?> GetIntlSubtitlesFromApi1Async(
            string aid,
            string cid,
            string epId,
            int index
        )
        {
            try
            {
                ...
                string api =
                    "https://"
                    + (Config.EPHOST == "api.bilibili.com" ? "api.biliintl.com" : Config.EPHOST)
                    + $"/intl/gateway/web/v2/subtitle?episode_id={epId}";
        ...
        private static async Task<List<Subtitle>?> GetIntlSubtitlesFromApi2Async(
            string aid,
            string cid,
            string epId,
            int index
        )
        {
            try
            {
                ...
                string api =
                    ...
                    + $"/intl/gateway/v2/ogv/view/app/season?ep_id={epId}&platform=android&s_locale=zh_SG"
        ...
        private static async Task<List<Subtitle>?> GetSubtitlesFromApi1Async(
            string aid,
            string cid,
            string epId,
            int index
        ...
        private static async Task<List<Subtitle>?> GetSubtitlesFromApi2Async(
            string aid,
            string cid,
            string epId,
            int index
        ...
        private static async Task<List<Subtitle>?> GetSubtitlesFromApi3Async(
            string aid,
            string cid,
            string epId,
            int index
        )
        {
            try
            {
                ...
                {
                    subtitles.AddRange(
                        resp.Subtitle.Subtitles.Select(item => new Subtitle()
                        {
        ...
        public static async Task<List<Subtitle>> GetSubtitlesAsync(
            string aid,
            string cid,
            string epId,
            int index,
        ...
        )
        {
            ...
            {
                subtitles =
                    await GetIntlSubtitlesFromApi1Async(aid, cid, epId, index)
                    ?? await GetIntlSubtitlesFromApi2Async(aid, cid, epId, index);
            }
            else
            {
                if (Config.COOKIE == "")
                ...
                {
                    subtitles =
                        await GetSubtitlesFromApi2Async(aid, cid, epId, index)
        ...
        private static string ConvertSubFromJson(string jsonString)
        {
            ...
            for (int i = 0; i < sub.Count; i++)
            {
                ...
                {
                    lines.AppendLine(
                        $"{FormatTime(from.GetDouble())} --> {FormatTime(line.GetProperty("to").GetDouble())}"
                    );
                }
                else
                {
