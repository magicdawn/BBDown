...
namespace BBDown.Core
{
    class AppHelper
    {
        ...
        private static readonly string API2 =
        ...
        private static string ConvertToDashJson(object data)
        {
            ...
            {
                clips.AddRange(
                    resp.Business.ClipInfo.Select(clip => new DashClip(clip.Start, clip.End, clip.ToastText))
                );
            }
    ...
    internal class DubbingInfo
    {
        ...
        public override bool Equals(object? obj) =>
            obj is DubbingInfo other
            && BackgroundAudio == other.BackgroundAudio
            && RoleAudioList == other.RoleAudioList;
